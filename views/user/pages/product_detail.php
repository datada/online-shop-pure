       ...
       <!-- Left Image-->
        <div class="span5">
          <ul class="thumbnails mainimage">
            ...
            <?php foreach($product_image as $item_image){ ?>
            <li class="span5">
              <a  rel="position: 'inside', showTitle: false, adjustX:-4, adjustY:-4" class="thumbnail cloud-zoom" <?php echo 'href="resources/upload/detail/'.$item_image['image'].'"' ?>>
                <img  <?php echo 'src="resources/upload/detail/'.$item_image['image'].'"'?> alt="" title="">
              </a>
            </li>
            <?php } ?>
          </ul>
          ...
          <div class="row">
            <div class="span7">
              ...
              <ul class="productpagecart">
                <li><a class="cart" href="<?php echo 'routes/mua-hang.php?id='.$product_detail['id'] ?>">ADD TO CART</a></li>
        ...
        <li class="span3">
          ...
          <div class="thumbnail">
            ...
            <div class="pricetag">
              ...
              <div class="price">
                <div class="pricenew"><?php echo number_format($item_related_product['price'],0,",",".") ?></div>
