...
class Product{
	...
	public static function getLastestProduct($numberOfProduct){
		$sql="select id,name,image,price,alias from products order by id DESC limit ".$numberOfProduct."";
		$lastest_product = Database::selectAll($sql);
		return $lastest_product;
	}

	public static function getLastestProductCate($cate_id, $numberOfProduct){
